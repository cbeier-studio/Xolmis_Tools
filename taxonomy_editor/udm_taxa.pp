...
type
  ...
  TdmTaxa = class(TDataModule)
    ...
    dsRanksI18n: TDataSource;
    dsPacks: TDataSource;
    dsRanks: TDataSource;
    dsMethodsI18n: TDataSource;
    ...
    qMethodsI18ncategory: TStringField;
    qMethodsI18ndescription: TMemoField;
    qMethodsI18ninsert_date: TDateTimeField;
    qMethodsI18nlanguage_id: TLongintField;
    qMethodsI18nlanguage_name: TStringField;
    qMethodsI18nmethod_id: TLongintField;
    qMethodsI18nmethod_name: TStringField;
    qMethodsI18nnotes: TMemoField;
    qMethodsI18nrecommended_uses: TMemoField;
    qMethodsI18nupdate_date: TDateTimeField;
    qRanksI18n: TSQLQuery;
    ...
    qRanksI18ninsert_date: TDateTimeField;
    qRanksI18nlanguage_id: TLongintField;
    qRanksI18nlanguage_name: TStringField;
    qRanksI18nrank_id: TLongintField;
    qRanksI18nrank_name: TStringField;
    qRanksI18nupdate_date: TDateTimeField;
